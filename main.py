...
def create_screen():
    ...
    window.geometry("540x660")# size of the window width:- 500, height:- 375
    window.resizable(0, 0)
    # broot.tkraise()
    # 'FedUni Money Manager' label here. Font size is 28.
    Label (window, text = "FedUni Money Manager", fg = "black", font= "none 28 bold") .grid(row = 0, sticky="w", padx= (40,10), pady=(15,15))
    Label(window, text = f'User Number: ', fg='black', font='none 11').grid(row = 2, sticky="w",padx= (30), pady=(30,15))
    Label(window, text = f'Balance: ', fg='black', font='none 11').grid(row = 2, sticky="w",padx= (210), pady=(30,15))
    Button(window, text='Log Out', fg= 'black', font='none 11',width= 12, height=3, bd =0,borderwidth=3,cursor='hand2', command= lambda:'').grid(row = 2, sticky="w",padx= (400), pady=(35,15))
    ...
    Label(window, text = f'Amount($) ', fg='black', font='none 11').grid(row = 3, sticky="w",padx= (30), pady=(30,15))
    tkVar=StringVar(window)
    amount_entry = tk.Entry(window)
    entry_type=tk.Entry(window)
    amount_entry = Entry(window, textvariable=tkVar, width = 27,background = 'white').grid(row = 3, sticky="w",padx= (180), pady=(30,15))
