...
entry_type_var = StringVar(root)
entry_type_var.set("one")
#entry_type=tk.Entry(root)
...
def create_screen():
    ...
    root.geometry("540x660")# size of the window width:- 500, height:- 375
    root.resizable(0, 0)
    # broot.tkraise()
    # 'FedUni Money Manager' label here. Font size is 28.
    Label (root, text = "FedUni Money Manager", fg = "black", font= "none 28 bold") .grid(row = 0, sticky="w", padx= (40,10), pady=(15,15))
    Label(root, text = f'User Number: ', fg='black', font='none 11').grid(row = 2, sticky="w",padx= (30), pady=(30,15))
    Label(root, text = f'Balance: ', fg='black', font='none 11').grid(row = 2, sticky="w",padx= (210), pady=(30,15))
    save_logout = Button(root, text='Log Out', fg= 'black', font='none 11',width= 12, height=3, bd =0,borderwidth=3,cursor='hand2', command= lambda:save_and_log_out()).grid(row = 2, sticky="w",padx= (400), pady=(0))
    ...
    # logout = Button(window, text = "Log Out", fg = "black", width = 24, height = 7, bd = 0, bg = "green", cursor = "hand2", command = lambda:create_LogIn_screen()).grid(row = 4, column = 1, sticky='se')

    # ----- Row 2 -----

    Label(root, text = f'Amount($) ', fg='black', font='none 11').grid(row = 3, sticky="w",padx= (30), pady=(30,15))
    # tkVar=StringVar(window)
    # amount_entry = tk.Entry(window)
    # entry_type=tk.Entry(window)
    amount_entry = Entry(root, textvariable=tkVar, width = 27,background = 'white').grid(row = 3, sticky="w",padx= (180), pady=(30,15))
    deposit_ = Button(root, text='Deposit', fg= 'black', font='none 11',width= 12, height=3, bd =0,borderwidth=3,cursor='hand2', command= lambda:save_and_log_out()).grid(row = 3, sticky="w",padx= (400), pady=(0))
    
    # Amount label here
    # Label (window, text = "FedUni Money Manager", fg = "black", font= "none 28 bold") .grid(row = 2, sticky="w", pady=(15,15))
    Label(root, text = f'Entry Type ', fg='black', font='none 11').grid(row = 4, sticky="w",padx= (30), pady=(30,15))
    entry_type_var = StringVar(root)
    entry_type_var.set("rent")
    entry_type = OptionMenu(root, entry_type_var, "rent", 'bills', 'entertainment','other').grid(row = 4, sticky="w",padx= (230), pady=(30,15))
    add_entry = Button(root, text='Add Entry', fg= 'black', font='none 11',width= 12, height=3, bd =0,borderwidth=3,cursor='hand2', command= lambda:'').grid(row = 4, sticky="w",padx= (400), pady=(0))
    canvas = Canvas(root, width = 540, height = 300, bg = "white").grid(row=5,sticky= 'nswe')
    # Amount entry here
    ...
    # # Deposit button here
    # deposit = Button(window, text = "deposit", fg = "black", width = 24, height = 7, bd = 0, bg = "green", cursor = "hand2", command = lambda:perform_deposit()).grid(row = 4, column = 2, padx = 1, pady = 1)
